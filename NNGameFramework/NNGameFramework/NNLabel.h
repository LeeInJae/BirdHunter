...
public:
	...
	static NNLabel* Create( wchar_t* string, wchar_t* fontFace, float fontSize, unsigned int colorValue);
...
public:
	...
	NND2DLabel( wchar_t* string, wchar_t* fontFace, float fontSize, unsigned int colorValue );
	virtual ~NND2DLabel();
